...
selected_stock = 'Reliance Industries Limited (RIL)'
...
stock_data = get_stock_data('RELIANCE.NS', selected_time_frame_key)
...
currency_symbol = '₹'  # Indian Rupee for Reliance
